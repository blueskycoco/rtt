...
if  CROSS_TOOL == 'gcc':
    PLATFORM 	= 'gcc'
    EXEC_PATH 	= r'C:/Users/dillon.min/MentorGraphics/Sourcery_CodeBench_Lite_for_ARM_EABI/bin'
...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' -g -Wall -DSTM32F40_41xxx -DSTM32F4XX -DUSE_STDPERIPH_DRIVER -D__ASSEMBLY__ -D__FPU_USED'
