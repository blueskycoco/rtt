...
#define UART1_TX_PIN_SOURCE GPIO_PinSource4
#define UART1_GPIO_RX       GPIO_Pin_5
#define UART1_RX_PIN_SOURCE GPIO_PinSource5
#define UART1_GPIO          GPIOC
#define UART1_GPIO_RCC      RCC_AHBPeriph_GPIOC
...
#define UART3_GPIO_RCC      RCC_AHBPeriph_GPIOD
#define RCC_APBPeriph_UART3 RCC_APB1Periph_USART3
#define UART3_TX_DMA        DMA1_Channel1
...
static void RCC_Configuration(void)
{
    ...
    RCC_AHBPeriphClockCmd(UART3_GPIO_RCC, ENABLE);
    /* Enable UART3 clock */
...
static void GPIO_Configuration(void)
{
    ...
    GPIO_PinAFConfig(UART1_GPIO, UART1_TX_PIN_SOURCE, GPIO_AF_7);
    GPIO_PinAFConfig(UART1_GPIO, UART1_RX_PIN_SOURCE, GPIO_AF_7);
#endif /* RT_USING_UART1 */
    ...
    /* Connect alternate function */
    GPIO_PinAFConfig(UART2_GPIO, UART2_TX_PIN_SOURCE, GPIO_AF_7);
    GPIO_PinAFConfig(UART2_GPIO, UART2_RX_PIN_SOURCE, GPIO_AF_7);
#endif /* RT_USING_UART2 */
    ...
    /* Connect alternate function */
    GPIO_PinAFConfig(UART3_GPIO, UART3_TX_PIN_SOURCE, GPIO_AF_7);
    GPIO_PinAFConfig(UART3_GPIO, UART3_RX_PIN_SOURCE, GPIO_AF_7);
#endif /* RT_USING_UART3 */
}
