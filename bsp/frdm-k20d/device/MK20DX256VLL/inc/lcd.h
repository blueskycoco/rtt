...
#define LCD_CS_HIGH()       FSL_LCD_CS_HIGH()
#define LCD_CS_LOW()        FSL_LCD_CS_LOW()
#define LCD_CD_HIGH()       FSL_LCD_CD_HIGH()
#define LCD_CD_LOW()        FSL_LCD_CD_LOW()
	...
	#include "gpio.h"
	#include "spi.h"
	#define LCD_SPI_SEND(x)	    SPI_SendReceive(SPI0,(x))
#endif
